...
Product.delete_all
product = Product.create(name: "Cat Pole Feather Dancer", category: toys, price: 7.99, description: "This cat dangler with natural feathers promises your cat hours of amusement.
